...
#> 12:22:06 UMAP embedding parameters a = 0.9922 b = 1.112
#> 12:22:06 Read 200 rows and found 10 numeric columns
#> 12:22:06 Using Annoy for neighbor search, n_neighbors = 30
#> 12:22:06 Building Annoy index with metric = cosine, n_trees = 50
...
#> *
#> |
#> 12:22:06 Writing NN index file to temp file /tmp/RtmppN08Ki/file1c9c44fa022f
#> 12:22:06 Searching Annoy index using 1 thread, search_k = 3000
#> 12:22:06 Annoy recall = 100%
#> 12:22:06 Commencing smooth kNN distance calibration using 1 thread
#>  with target n_neighbors = 30
#> 12:22:08 Initializing from normalized Laplacian + noise (using RSpectra)
#> 12:22:08 Commencing optimization for 500 epochs, with 6146 positive edges
#> 12:22:08 Using rng type: pcg
#> 12:22:08 Optimization finished
