...
You can find the status of development of **{anndataR}** on the [feature tracking page](https://anndataR.scverse.org/articles/design.html#feature-tracking) of the package website. 
