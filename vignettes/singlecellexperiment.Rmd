...
```{r to_ad_implicit_easy}
ad_implicit_obsvar <- from_SingleCellExperiment(
  sce,
  layers_mapping = list(),
  obsm_mapping = list(), 
  varm_mapping = list(), 
...
```{r to_ad_implicit_colPairs}
ad_implicit_colpairs <- from_SingleCellExperiment(
  sce,
  layers_mapping = list(),
  obsm_mapping = list(), 
  varm_mapping = list(), 
...
```{r to_ad_implicit_uns}

ad_implicit_uns <- from_SingleCellExperiment(
  sce,
  x_mapping = "counts",
  obsm_mapping = list(),
  varm_mapping = list()
