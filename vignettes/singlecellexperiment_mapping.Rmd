...
In order for the implicit conversion to work, we will not provide a `layers_mapping` or `x_mapping` argument.
...
```{r explicit_x}
sce_assays_x <- to_SingleCellExperiment(
  ad,
  x_mapping = "counts",
