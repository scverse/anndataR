...
test_that("Writing H5AD dense arrays works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "dense_array", native = TRUE)
...
test_that("Writing H5AD sparse arrays works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "csc_array", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
  ...
  attrs <- rhdf5::h5readAttributes(file, "csr_array", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
...
test_that("Writing dgeMatrix", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "dgematrix", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
  expect_equal(attrs[["encoding-type"]], "array")
})
...
test_that("Writing H5AD nullable booleans works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "nullable_bool", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
...
test_that("Writing H5AD nullable integers works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "nullable_int", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
...
test_that("Writing H5AD string arrays works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "string_array", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
  ...
  attrs <- rhdf5::h5readAttributes(file, "string_array2D", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
  expect_equal(attrs[["encoding-type"]], "string-array")
})
...
test_that("Writing H5AD categoricals works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "categorical", native = TRUE)
...
test_that("Writing H5AD string scalars works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "string_scalar", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
...
test_that("Writing H5AD numeric scalars works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "numeric_scalar", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
...
test_that("Writing H5AD mappings works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "mapping", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
...
test_that("Writing H5AD data frames works", {
  ...
  attrs <- rhdf5::h5readAttributes(file, "dataframe", native = TRUE)
  expect_true(all(c("encoding-type", "encoding-version") %in% names(attrs)))
...
#   rhdf5_write_h5ad(adata, h5ad_file_none, compression = "none")
#   rhdf5_write_h5ad(adata, h5ad_file_gzip, compression = "gzip")
...
#   rhdf5_write_h5ad(adata, h5ad_file_none, compression = "none")
#   rhdf5_write_h5ad(adata, h5ad_file_lzf, compression = "lzf")
