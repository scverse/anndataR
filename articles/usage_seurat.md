...
#> [1] Seurat_5.5.1       SeuratObject_5.4.0 sp_2.2-3           anndataR_1.2.1    
#> [5] BiocStyle_2.41.0  
#> 
...
#>  [13] curl_7.1.0             Rhdf5lib_2.1.0         rhdf5_2.57.9          
...
#>  [46] progressr_1.0.0        Rarr_2.1.32            spatstat.sparse_3.2-0 
#>  [49] httr_1.4.8             polyclip_1.10-7        abind_1.4-8           
#>  [52] compiler_4.6.1         S7_0.2.2               fastDummies_1.7.6     
...
#>  [67] rhdf5filters_1.25.4    promises_1.5.0         grid_4.6.1            
#>  [70] Rtsne_0.17             cluster_2.1.8.2        reshape2_1.4.5        
#>  [73] generics_0.1.4         gtable_0.3.6           spatstat.data_3.1-9   
#>  [76] R.methodsS3_1.8.2      tidyr_1.3.2            data.table_1.18.4     
#>  [79] spatstat.geom_3.8-2    RcppAnnoy_0.0.23       ggrepel_0.9.8         
...
#>  [91] survival_3.8-6         deldir_2.0-4           paws.common_0.8.10    
#>  [94] tidyselect_1.2.1       miniUI_0.1.2           pbapply_1.7-4         
#>  [97] knitr_1.51             gridExtra_2.3.1        bookdown_0.47         
#> [100] scattermore_1.2        xfun_0.60              matrixStats_1.5.0     
#> [103] stringi_1.8.9          yaml_2.3.12            evaluate_1.0.5        
#> [106] codetools_0.2-20       tibble_3.3.1           BiocManager_1.30.27   
#> [109] cli_3.6.6              uwot_0.2.4             xtable_1.8-8          
#> [112] reticulate_1.46.0      systemfonts_1.3.2      jquerylib_0.1.4       
#> [115] Rcpp_1.1.2             globals_0.19.1         spatstat.random_3.5-1 
#> [118] png_0.1-9              spatstat.univar_3.2-0  parallel_4.6.1        
#> [121] pkgdown_2.2.1          ggplot2_4.0.3          dotCall64_1.2         
