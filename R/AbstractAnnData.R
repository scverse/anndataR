...
AbstractAnnData <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return A [AnnDataView] object with the specified observations
    subset_obs = function(condition) {
      view <- AnnDataView$new(self)
    ...
    #'
    #' @return A [AnnDataView] object with the specified variables
    ...
    #'
    #' @return A [AnnDataView] object with renamed obs columns
    rename_obs = function(...) {
      view <- AnnDataView$new(self)
      view$rename_obs(...)
    },
    ...
    #' @param ... Named arguments where names are new column names and values are old column names
    #'
    #' @return A [AnnDataView] object with renamed var columns
    rename_var = function(...) {
      view <- AnnDataView$new(self)
      view$rename_var(...)
    },
    ...
    #'
    #' @return A [AnnDataView] object with renamed obsm keys
    ...
    #' @param ... Named arguments where names are new keys and values are old keys
    #'
    #' @return A [AnnDataView] object with renamed varm keys
    ...
    #' @param ... Named arguments where names are new keys and values are old keys
    #'
    #' @return A [AnnDataView] object with renamed obsp keys
    ...
    #' @param ... Named arguments where names are new keys and values are old keys
    #'
    #' @return A [AnnDataView] object with renamed varp keys
    ...
    #' @param ... Named arguments where names are new keys and values are old keys
    #'
    #' @return A [AnnDataView] object with renamed layers keys
    ...
    #' @param ... Named arguments where names are new keys and values are old keys
    #'
    #' @return A [AnnDataView] object with renamed uns keys
    rename_uns = function(...) {
      view <- AnnDataView$new(self)
      view$rename_uns(...)
    },
    ...
    #'
    #' @return A [AnnDataView] object with the transformation applied
