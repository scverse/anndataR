...
write_zarr_sparse_array <- function(
  ...
  # Write sparse matrix
  Rarr::write_zarr_group(store, name)
  zarr_write_compressed(
    store,
    paste0(name, "/indices"),
